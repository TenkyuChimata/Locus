...
struct JapanRegionProfile: Equatable, Sendable {
    ...
    private static let verifiedModels: [String: (String, String)] = [
        "iPhone16,1": ("iPhone 15 Pro", "A2848"),
        "iPhone16,2": ("iPhone 15 Pro Max", "A2849"),
        "iPhone17,1": ("iPhone 16 Pro", "A3083"),
        "iPhone17,2": ("iPhone 16 Pro Max", "A3084"),
        "iPhone17,3": ("iPhone 16", "A3081"),
        "iPhone17,4": ("iPhone 16 Plus", "A3082"),
        "iPhone17,5": ("iPhone 16e", "A3212"),
        "iPad13,4": ("iPad Pro 11-inch (M1)", "A2377"),
        "iPad13,5": ("iPad Pro 11-inch (M1)", "A2459"),
        "iPad13,6": ("iPad Pro 11-inch (M1)", "A2301"),
        "iPad13,7": ("iPad Pro 11-inch (M1)", "A2301"),
        "iPad13,8": ("iPad Pro 12.9-inch (M1)", "A2378"),
        "iPad13,9": ("iPad Pro 12.9-inch (M1)", "A2461"),
        "iPad13,10": ("iPad Pro 12.9-inch (M1)", "A2379"),
        "iPad13,11": ("iPad Pro 12.9-inch (M1)", "A2379"),
        "iPad13,16": ("iPad Air (M1)", "A2588"),
        "iPad13,17": ("iPad Air (M1)", "A2589"),
        "iPad14,3": ("iPad Pro 11-inch (M2)", "A2759"),
        "iPad14,4": ("iPad Pro 11-inch (M2)", "A2435"),
        "iPad14,5": ("iPad Pro 12.9-inch (M2)", "A2436"),
        "iPad14,6": ("iPad Pro 12.9-inch (M2)", "A2764"),
